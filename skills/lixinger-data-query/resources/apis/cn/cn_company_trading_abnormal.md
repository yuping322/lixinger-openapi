...
## 调用示例
```bash
/opt/anaconda3/bin/python3 skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/company/trading-abnormal" --params '{"stockCodes": ["600519"], "date": "2024-12-30"}'
```
