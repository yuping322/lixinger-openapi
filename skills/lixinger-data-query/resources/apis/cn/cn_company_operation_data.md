...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/company/operating-data" --params '{"startDate": "2020-01-01", "endDate": "2024-12-31", "stockCodes": ["600519"], "stockCode": "600519"}'
```
