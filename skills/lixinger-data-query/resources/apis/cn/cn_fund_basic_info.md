# API 规范: cn/fund/basic-info (基金基本信息)

获取基金基本信息数据

## 接口地址
- **URL 后缀**: `cn/fund/basic-info`
- **支持格式**: `cn.fund.basic-info`
...
## 调用示例
```bash
/opt/anaconda3/bin/python3 skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/fund/basic-info" --params '{"stockCodes": ["600519"], "date": "2024-12-30"}'
```
