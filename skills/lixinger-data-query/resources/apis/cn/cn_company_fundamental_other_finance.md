...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/company/fundamental/other_financial" --params '{"date": "2024-12-31", "metricsList": ["pe_ttm"], "stockCodes": ["600519"]}'
```
