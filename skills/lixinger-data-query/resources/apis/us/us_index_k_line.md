# API 规范: us/index/k-line (美股指数K线数据)

获取美股指数K线数据

## 接口地址
- **URL 后缀**: `us/index/k-line`
- **支持格式**: `us.index.k-line`
...
## 调用示例
```bash
/opt/anaconda3/bin/python3 skills/lixinger-data-query/scripts/query_tool.py --suffix "us/index/k-line" --params '{"stockCodes": ["600519"], "date": "2024-12-30"}'
```
