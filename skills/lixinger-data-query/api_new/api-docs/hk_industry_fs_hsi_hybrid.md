...
获取财务数据，如营业收入、ROE等。 说明: 指标计算请参考行业财务数据计算

## 请求URL

```
https://open.lixinger.com/api/hk/industry/fs/hsi/hybrid
```
...
| stockCodes | Yes | Array | 行业代码数组。stockCodes长度>=1且<=100，格式如下：["H50","H5010"]。<br>请参考行业信息API获取合法的stockCode。<br>需要注意的是，当传入startDate时只能传入一个股票代码。 |
