...
```
https://open.lixinger.com/api/hk/industry
```
...
| stockCodes | No | Array | 行业代码数组。默认值为所有行业的股票代码。格式如下：["H50","H5010"]。<br>请参考行业信息API获取合法的stockCode。 |
| source | Yes | String | 行业来源，例如：{source}。<br>当前支持:<br>恒生: hsi |
