...
Run commands from this skill directory. Shared scripts live in `../findata-toolkit/`. (Design rebalancing rules (threshold/time-based), constraints, and an execution checklist. Use when the user asks how to rebalance a portfolio or wants a rebalancing plan.)
