...
Run commands from this skill directory. Shared scripts live in `../findata-toolkit/`. (Assess yield curve shape, inversion signals, term premiums, and macro implications. Use when the user asks about the yield curve, inversion, or rate-regime impacts.)
