...
Run commands from this skill directory. Shared scripts live in `../findata-toolkit/`. (Track macro liquidity indicators (rates, inflation, credit, central bank stance) and summarize implications for assets/sectors. Use when the user asks about liquidity conditions or policy-driven market impacts.)
...
| Script | Primary use |
| --- | --- |
| macro_data.py | FRED macro dashboard (rates, inflation, credit proxies). |
