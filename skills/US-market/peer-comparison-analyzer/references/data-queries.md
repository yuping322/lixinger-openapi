...
Run commands from this skill directory. Shared scripts live in `../findata-toolkit/`. (Build peer comps and explain differences in valuation, growth, profitability, leverage, and cash flow quality. Use when the user asks for comparable company analysis or peer-relative valuation.)
