...
Run commands from this skill directory. Shared scripts live in `../findata-toolkit/`. (Monitor factor crowding and factor performance dispersion to identify crowded trades and rotation risk. Use when the user asks about factor crowding, style squeeze risk, or factor rotation signals.)
...
| Script | Primary use |
| --- | --- |
| factor_screener.py | Factor scoring / screening engine. |
