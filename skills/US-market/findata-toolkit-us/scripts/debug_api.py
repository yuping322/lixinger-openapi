...
def debug():
    ...
    res1 = client.fetch("us/company/basic-info", {"stockCodes": ["600519"]})
    print(json.dumps(res1, indent=2, ensure_ascii=False))
    
    print("\n--- cn/company/related-industry ---")
    res1_5 = client.fetch("us/company/related-industry", {"stockCodes": ["600519"]})
    print(json.dumps(res1_5, indent=2, ensure_ascii=False))

    print("\n--- cn/company/fundamental/non_financial ---")
    res2 = client.fetch("us/company/fundamental/non_financial", {
        "stockCodes": ["600519"], 
