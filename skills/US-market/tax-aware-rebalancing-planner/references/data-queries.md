...
Run commands from this skill directory. Shared scripts live in `../findata-toolkit/`. (Plan rebalancing with tax constraints (realized gains, lot selection, wash-sale awareness) and an execution checklist. Use when the user asks for tax-aware rebalancing or minimizing taxes while rebalancing.)
...
| Script | Primary use |
| --- | --- |
| portfolio_analytics.py | Portfolio analytics (risk, drawdown, stress, basic optimization helpers). |
