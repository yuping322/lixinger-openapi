...
Run commands from this skill directory. Shared scripts live in `../findata-toolkit/`. (Aggregate insider buying/selling patterns across multiple tickers to identify management confidence signals. Use when the user asks for market-wide insider activity scans or insider sentiment dashboards.)
