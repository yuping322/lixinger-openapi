...
Run commands from this skill directory. Shared scripts live in `../findata-toolkit/`. (Track credit spreads (IG/HY), default risk proxies, and stress signals; summarize equity implications. Use when the user asks about credit conditions or spread widening/tightening.)
