...
Run commands from this skill directory. Shared scripts live in `../findata-toolkit/`. (Generate an institutional-style investment memo (thesis, valuation, catalysts, risks, monitoring) from structured inputs and supporting data. Use when the user asks for an investment memo, write-up, or pitch.)
