...
Run commands from this skill directory. Shared scripts live in `../findata-toolkit/`. (Orchestrate portfolio monitoring: risk, concentration, factor/style exposure, liquidity, and scenario checks into one report. Use when the user asks for an end-to-end portfolio review/monitoring report.)
