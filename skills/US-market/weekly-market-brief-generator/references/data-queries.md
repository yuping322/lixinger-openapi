...
Run commands from this skill directory. Shared scripts live in `../findata-toolkit/`. (Produce a weekly market brief (performance, macro, flows, risks, watchlist) with consistent sections and tables. Use when the user asks for a weekly market update/brief.)
