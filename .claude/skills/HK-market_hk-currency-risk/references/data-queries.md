...
6. **API 文档**：详细的 API 文档位于 `../../../plugins/query_data/lixinger-api-docs/api-docs/macro_currency-exchange-rate.md`
...
- **汇率 API 文档**：`../../../plugins/query_data/lixinger-api-docs/api-docs/macro_currency-exchange-rate.md`
