...
```bash
# 财务指标
grep -i "分红\|股息" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "市盈率\|PE" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "市净率\|PB" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "ROE\|净资产收益率" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "营业收入\|营收" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "净利润" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md

# 交易数据
grep -i "K线\|行情\|股价" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "成交量\|成交额" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md

# 资金流向
grep -i "融资融券\|两融" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "大宗交易" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "龙虎榜" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "陆股通\|港股通\|北向资金\|南向资金" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md

# 公司事件
grep -i "公告\|披露" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "配股" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "增减持" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "股权质押" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md

# 持股数据
grep -i "股东" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "基金持股\|机构持仓" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md

# 指数和行业
grep -i "指数\|成分股" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "行业\|板块" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md

# 宏观数据
grep -i "GDP\|CPI\|PPI" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "货币供应\|M0\|M1\|M2" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
grep -i "汇率\|外汇" plugins/query_data/lixinger-api-docs/API_KEYWORD_INDEX.md
```
