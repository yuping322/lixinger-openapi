...
> 当前默认执行层继续复用 `.claude/plugins/query_data/lixinger-api-docs`。
...
- `.claude/plugins/query_data/lixinger-api-docs`：负责默认执行查询
...
使用 Python 直接调用或复用 `.claude/plugins/query_data/lixinger-api-docs` 下已有文档与示例。
